...
<div class="d-flex flex-column min-vh-100">
    ...
    <div class="container-lg py-5 flex-grow-1">
        ...
        <div class="card border-0 shadow-sm p-4 rounded-4 mb-5 bg-white">
            <form id="studentItemsFiltersForm" action="{{ route('search') }}" method="GET">
                <div class="row g-3">
                    {{-- Search --}}
                    <div class="col-lg-5">
                    ...
                    {{-- Category --}}
                    <div class="col-lg-3">
                        <select name="category" class="form-select form-select-lg bg-light filter-select">
                    ...
                    <div class="col-lg-2">
                        <input
                            type="date"
                            name="date"
                            class="form-control form-control-lg bg-light filter-select"
                            value="{{ request('date') }}"
                        >
                    </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="custom-card h-100 d-flex flex-column shadow-sm border rounded-3 overflow-hidden">
                    ...
                    <div class="p-4 flex-grow-1 d-flex flex-column">
                        ...
                        {{-- Claim Button --}}
                        <a href="{{ route('appointments.claim', $item->id) }}"
                           class="btn btn-sm btn-success mt-3"
                           @if($item->status !== 'unclaimed') disabled @endif>
                            Claim
                        </a>
                    </div>
                </div>
