            ...
            <div class="row g-3">
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-lg bg-light border-start-0" placeholder="What are you looking for? (e.g. Wallet)">
                    </div>
                </div>
                <div class="col-lg-3">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="custom-card h-100 d-flex flex-column">
                ...
                <div class="p-4 flex-grow-1 d-flex flex-column">
                    ...
                    <a href="{{ url('/book-appointment') }}" class="btn btn-outline-custom w-100 mt-3 btn-sm">
                        Claim
                    </a>
                </div>
            </div>
