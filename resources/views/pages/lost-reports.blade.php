        ...
        <div class="table-card">
            <div class="table-header">
                <div class="d-flex align-items-center gap-2">
                    <h5 class="mb-0">All Lost Items <span class="text-muted ms-1">({{ $lostItems->count() }})</span></h5>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Date" style="white-space: nowrap;">
                                <i class="fas fa-calendar-alt text-muted me-1"></i> {{ $item->date_found }}
                            </td>
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-5 text-muted">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <p class="mb-0">No lost item reports found.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title fw-bold">Lost Item Details</h5>
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <small class="text-muted d-block fw-bold">Date Lost</small>
